        ...
        >
          ...
          >
            <motion.button
              ...
              className={`p-2 rounded-btn transition-colors ${view === "grid" ? "bg-gw-red/10 text-gw-red" : "text-gw-gray-300 hover:text-gw-gray-500"}`}
            >
            ...
            <motion.button
              ...
              className={`p-2 rounded-btn transition-colors ${view === "list" ? "bg-gw-red/10 text-gw-red" : "text-gw-gray-300 hover:text-gw-gray-500"}`}
            >
