                        ...
                        >
                          ...
                          <div className="absolute top-2 right-2 flex items-start gap-1">
                            ...
                            <button
                              ...
                              className="p-1 rounded bg-white/90 shadow-sm text-gw-gray-300 hover:text-gw-red transition-colors"
                          ...
                          <div className="p-2 border-t border-gw-border bg-gray-50 space-y-1.5">
                            <input
                              ...
                              className="w-full h-7 px-2 text-[11px] rounded-md border border-gw-border focus:outline-none focus:border-gw-red"
                            ...
                            {!img.isPrimary && (
                              <button
                                ...
                                className="w-full h-7 text-[11px] font-semibold rounded-md border border-gw-gray-300 text-gw-gray-500 hover:border-gw-red hover:text-gw-red transition-colors"
                              >
                                Set as cover
                              </button>
                            )}
